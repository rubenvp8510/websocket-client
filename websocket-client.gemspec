Gem::Specification.new do |gem|
  ...
  gem.version     = '0.0.1'
  gem.date        = '2017-06-21'
  gem.summary     = 'This is a websocket client based on faye websocket driver'
  gem.description = 'This is a websocket client based on faye websocket driver'
  gem.authors     = ['Ruben Vargas']
  gem.email       = 'rvargasp@redhat.com'
  gem.files       = ['lib/websocket_client.rb']
