...
describe SyncWebSocket::Client do
  it "cannot open a connection to the wrong host" do
      expect { SyncWebSocket::Client.connect 'ws://localhost' }.to raise_exception(SyncWebSocket::ConnectionError)
      expect { SyncWebSocket::Client.connect 'ws://not-exist.host.com' }.to raise_exception(SyncWebSocket::ConnectionError)
  end
